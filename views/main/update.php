<form id="formulario" method="post" action="./index.php?controller=main&action=update&id=<?= isset($row) ? $row->id : null ?>" >
<div class="form-group">
  ...
  <div class="form-group">
    <label> Peso </label>
    <input type='number' class="form-control" id="peso" name="prueba[peso]" value="<?= isset($row) ? $row->peso : null ?>" required />
  </div>
  <div class="form-group">
